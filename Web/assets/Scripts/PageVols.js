...
const airlines = {
    'Air France': {
        name: 'Air France',
        logoUrl: 'https://img.icons8.com/color/48/air-france.png'
    },
    'British Airways': {
        name: 'British Airways',
        logoUrl: 'https://img.icons8.com/color/48/british-airways.png'
    },
    'Lufthansa': {
        name: 'Lufthansa',
        logoUrl: 'https://img.icons8.com/color/48/lufthansa.png'
    },
    'Emirates': {
        name: 'Emirates',
        logoUrl: 'https://img.icons8.com/color/48/emirates.png'
    },
    'Qatar Airways': {
        name: 'Qatar Airways',
        logoUrl: 'https://img.icons8.com/color/48/qatar-airways.png'
    }
};
...
function filterFlights() {
  ...
  const activeTimeFilter = Array.from(timeFilters).find(filter => filter.classList.contains('active'));
  ...
  currentFlights = flightData.filter(flight => {
    ...
    if (activeTimeFilter) {
      const filterRange = activeTimeFilter.dataset.range.split('-');
      const startTime = parseInt(filterRange[0]);
      const endTime = parseInt(filterRange[1]);
      const departureHour = parseInt(flight.departureTime.split(':')[0]);
      if (departureHour < startTime || departureHour >= endTime) return false;
    }
