...
CREATE TABLE `Reservation` (
  ...
  `statut` VARCHAR(10) DEFAULT 'confirmée' CHECK (`statut` IN ('confirmée', 'annulée')),
) ;
...
--
ALTER TABLE `Messages_contact`
  MODIFY `id` INTEGER PRIMARY KEY AUTOINCREMENT AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `Vol`
  MODIFY `id` INTEGER PRIMARY KEY AUTOINCREMENT AUTO_INCREMENT, AUTO_INCREMENT=13;
