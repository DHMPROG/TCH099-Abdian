          ...
          <section class="baggage-info">
            ...
            <div class="baggage-selection">
              ...
              <div class="baggage-illustration">
                <img src="" alt="Illustration bagages" class="baggage-img">
              </div>
            </div>
          </section>
        </section>
...
-->
          ...
          <button class="btn btn-outline select-seats">Sélectionner sièges</button>
        </aside>
      </div>

      <div class="form-actions">
        <button class="btn btn-primary" id="submitForm">Enregistrer et fermer</button>
        <button class="btn btn-outline" id="selectSeats">Sélectionner sièges</button>
      </div>
    </div>
  </main>
	<footer>
